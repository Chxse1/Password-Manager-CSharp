...
namespace Manager {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PasswordsDataTable : global::System.Data.TypedTableBase<PasswordsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PasswordsRow AddPasswordsRow(string Site, string Phone, string Email, string Username, string Password) {
        ...
        public partial class PasswordsRow : global::System.Data.DataRow {
            ...
            public string Site {
                get {
                    try {
                        return ((string)(this[this.tablePasswords.SiteColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Site\' in table \'Passwords\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePasswords.SiteColumn] = value;
                }
            }
            ...
            public string Phone {
                get {
                    try {
                        return ((string)(this[this.tablePasswords.PhoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Phone\' in table \'Passwords\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePasswords.PhoneColumn] = value;
                }
            }
            ...
            public string Email {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Email\' in table \'Passwords\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsSiteNull() {
                return this.IsNull(this.tablePasswords.SiteColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetSiteNull() {
                this[this.tablePasswords.SiteColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsPhoneNull() {
                return this.IsNull(this.tablePasswords.PhoneColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPhoneNull() {
                this[this.tablePasswords.PhoneColumn] = global::System.Convert.DBNull;
            }
...
namespace Manager.Database1DataSetTableAdapters {
    ...
    public partial class PasswordsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Passwords] WHERE (([Id] = @Original_Id) AND ((@IsNull_Site = 1 AND [Site] IS NULL) OR ([Site] = @Original_Site)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Passwords] ([Site], [Phone], [Email], [Username], [Password]) " +
                "VALUES (@Site, @Phone, @Email, @Username, @Password);\r\nSELECT Id, Site, Phone, E" +
                "mail, Username, Password FROM Passwords WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Passwords] SET [Site] = @Site, [Phone] = @Phone, [Email] = @Email, [Username] = @Username, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_Site = 1 AND [Site] IS NULL) OR ([Site] = @Original_Site)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, Site, Phone, Email, Username, Password FROM Passwords WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Manager.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Site, Phone, Email, Username, Password FROM dbo.Passwords";
        ...
        public virtual int Fill(Database1DataSet.PasswordsDataTable dataTable) {
        ...
        public virtual Database1DataSet.PasswordsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.PasswordsDataTable dataTable = new Database1DataSet.PasswordsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.PasswordsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Site, string Original_Phone, string Original_Email, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string Site, string Phone, string Email, string Username, string Password) {
            if ((Site == null)) {
        ...
        public virtual int Update(string Site, string Phone, string Email, string Username, string Password, int Original_Id, string Original_Site, string Original_Phone, string Original_Email, string Original_Username, string Original_Password, int Id) {
            if ((Site == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Site, string Phone, string Email, string Username, string Password, int Original_Id, string Original_Site, string Original_Phone, string Original_Email, string Original_Username, string Original_Password) {
            return this.Update(Site, Phone, Email, Username, Password, Original_Id, Original_Site, Original_Phone, Original_Email, Original_Username, Original_Password, Original_Id);
        }
    }
